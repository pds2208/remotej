...
/**
 * Copyright(c) Paul Soule. All rights reserved. <p/> This is the base class for
 * all protocol implementations. To add a new protocol, subclass this class and
...
public abstract class Protocol implements IProtocol {
    ...
    *            if there is a problem validating options
    */
